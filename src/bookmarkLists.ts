...
const bookmarkLists: BookmarkList[] = [
  {
    title: 'first',
    bookmarks: [
      { title: 'Facebook', url: 'https://web.facebook.com' },
      { title: 'Gmail', url: 'https://mail.google.com/' },
      { title: 'GitHub', url: 'https://github.com/' },
      { title: 'Keep', url: 'https://keep.google.com' },
      { title: 'Drive', url: 'https://drive.google.com/drive/' },
  ...
  },
  {
    title: 'fifth',
    bookmarks: [
      { title: 'r/OnePiece', url: 'https://www.reddit.com/r/OnePiece' },
      { title: 'r/webdev', url: 'https://www.reddit.com/r/webdev' },
      { title: 'r/Dota2', url: 'https://www.reddit.com/r/Dota2' },
    ],
  },
]
